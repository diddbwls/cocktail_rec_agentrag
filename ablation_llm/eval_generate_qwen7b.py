#!/usr/bin/env python3
"""
Qwen 7B 모델 평가용 답변 생성 스크립트 (Ablation: Direct LLM)
이 파일을 실행하면 output 폴더에 Qwen 7B모델로 cocktail_eval_data에 대해 생성한 답변 파일이 생성됨
...
####################################################
# 모델 설정 
# config.LLM_MODEL = "Qwen/Qwen2.5-VL-3B-Instruct"
# config.LLM_MODEL = "Qwen/Qwen2.5-VL-7B-Instruct"
# config.LLM_MODEL = "gpt-4o-mini"


import utils.config as config
config.LLM_MODEL = "Qwen/Qwen2.5-VL-7B-Instruct"
EVAL_DATA_COUNT = None  # 평가할 데이터 개수 (전체: None, 일부: 숫자)
####################################################
...
# 출력 파일 path
output_file = f'./ablation_llm/output/{config.LLM_MODEL.replace("/", "_")}_ablation_llm.csv'
